...
//{{{ begin codeInclude
#line 0 "/home/renu/example292/example_2_9_2/constant/yd.#codeStream"
#include "fvCFD.H"
//}}} end codeInclude
...
extern "C"
{
    void codeStream_3d2d6985c2654bee6358eb6b9168f1d0f063e779
    (
        Ostream& os,
...
const IOdictionary& d = static_cast<const IOdictionary&>(dict);
		...
		//Td[i] = sin(*x);   
                   yd[i] = -(142.0/3.0)+12.0*(   Foam::pow(x-0.5,2.0)     +Foam::pow(y-0.5,2.0));  
